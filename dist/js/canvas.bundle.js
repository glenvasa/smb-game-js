...
var ctx = canvas.getContext("2d"); // changed from window innerwidth/height to 16:9 aspect ratio for better responsivity
...
var Player = /*#__PURE__*/function () {
  ...
  _createClass(Player, [{
    key: "draw",
    value: function draw() {
      ctx.drawImage(this.currentSprite, // cropping x, y position
      this.currentCropWidth * this.frames, 0, // crop width, height
...
function animate() {
  ...
  // this code replaced right/left event listener code although that code appeared to work fine
...
addEventListener("keyup", function (_ref4) {
  ...
  switch (keyCode) {
    case 65:
      // 'a' left
      keys.left.pressed = false; // player.currentSprite = player.sprites.stand.left
      // player.currentCropWidth = player.sprites.stand.cropWidth
      // player.width = player.sprites.stand.width
    ...
    case 68:
      // 'd' right
      keys.right.pressed = false; // player.currentSprite = player.sprites.stand.right
      // player.currentCropWidth = player.sprites.stand.cropWidth
      // player.width = player.sprites.stand.width
